...
- 下载地址：[animator-clip](https://registry.npmmirror.com/animator-clip/download/animator-clip-1.4.7.tgz)
...
<script src="https://unpkg.com/animator-clip@1.4.7/lib/animator-clip.umd.js"></script>
...
# 安装指定版本
npm install animator-clip@1.4.7
```
